...
- [ ] **PR1.75 — full option (g), the ruled activation shape, TRIAD
      ...
      **Status 2026-09-02: server half BUILT (PR1.75a, #<n>) — migration
      0020 (renumbered to 0021 if #268 merges first — the #248
      precedent), both identity ladders, `authVia`, the styled pages;
      native half is PR1.75b (`WebAuthPlugin`, `linkFlow`, the
      return-arm census, the walk). The per-clause disposition of this
