...
md-pr2 | DONE | PR 2 — a lifecycle seam on useMonitorSession, and publish axes | merged | #413 → main bed5c1e4; `vi.doMock("../adapters/appLifecycle")` under app/src/monitor: 26 at phase open (#403) → 0
