...
Status: RUN 2026-09-05 — case 1 COMPLETE; case 2 stopped because the PM5 stopped emitting its NFC tag (not our app/helper); see [RECOVERY-WALK-V3-RESULT.md](RECOVERY-WALK-V3-RESULT.md). Run and consent consumed.
