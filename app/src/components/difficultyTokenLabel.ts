 ...
 *  Task 1) to this shared home, mirroring the precedent TIME's token label
 *  helper set (now `durationRangeLabel.ts`; its bucket-era predecessor was
 *  deleted in Phase SF PR2): Library's own DIFFICULTY token
