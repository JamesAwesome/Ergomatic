...
89. **A census of "every path that destroys row X" is a census of CASCADES,
...
90. **A guard keyed on a CONTAINER identity when the question is about a
    ...
    reads it.
91. **A "this literal appears exactly once" census test is a spelling pin —
