...
- [ ] **`type: "rower"` is still hardcoded for machines the denylist lets
      ...
      **Moved here from Phase MT when it was prepared for close, 2026-09-19:**
      ...
      the fence row below. It carries no date of its own because it is a
      wave row: it dies with Wave E's status-line stamp, 2026-10-17.
...
- **Reading what the monitor IS — firmware version, and classifying a
  ...
  verbatim — the first lifted out of Wave E, the second lifted out of Phase MT
  at its close, both 2026-09-19. · dies 2026-11-13 · iceboxed on a single unreproduced report; the
