...
4. **End-of-workout split frames DO arrive on iOS**: 0x0037 (18B) and 0x0038 (19B) delivered 1ms apart at the finish of a 1-interval piece. The 7C capture path still recorded 0 of 1 intervals — a driver/record-layer ordering race, not a transport loss (7C was never hardware-walked before today on any platform).
